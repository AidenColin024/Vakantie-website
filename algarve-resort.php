...
<head>
    ...
    <title>Algarve Resort - Portugal</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Algarve Resort – 4 sterren</h1>
        <div class="hotel-images">
            <img src="images/portugal-algarve.jpg" alt="Algarve Resort">
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Geniet van zon, zee en comfort in dit luxe resort aan de kust van de Algarve. Perfect voor strandliefhebbers en gezinnen.</p>
