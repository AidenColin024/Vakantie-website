...
<head>
    ...
    <title>Polar & Paradise - Italië</title>
...
<section class="vakantie">
    <img src="images/italie-hero.jpg" alt="Skiën in Italië">
    <div class="hero-text">
    ...
    <section class="search-bar">
        ...
        <input type="text" placeholder="Italië">
...
<main class="pp-content">
    ...
    <section class="pp-destinations">
        <div class="pp-country">
            <a href="dolomieten-chalet.php">
                <img src="images/italie-hotel1.jpg" alt="Dolomieten Chalet">
                <p>Dolomieten Chalet – 4 sterren</p>
            </a>
        </div>
        <div class="pp-country">
            <a href="val-gardena-resort.php">
                <img src="images/italie-hotel2.jpg" alt="Val Gardena Resort">
                <p>Val Gardena Resort – 5 sterren</p>
            </a>
        </div>
        <div class="pp-country">
            <a href="cervinia-lodge.php">
                <img src="images/italie-hotel3.jpg" alt="Cervinia Lodge">
                <p>Cervinia Lodge – 3 sterren</p>
            </a>
        </div>
        <div class="pp-country">
            <a href="dolomiti-resort.php">
                <img src="images/dolomiti-resort.jpg" alt="Dolomiti Resort">
                <p>Dolomiti Resort – 4 sterren</p>
            </a>
        </div>
    </section>
</main>
