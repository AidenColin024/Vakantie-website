...
<head>
    ...
    <title>Hotel Edelweiss Zermatt – Zwitserland</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Hotel Edelweiss Zermatt – 3 sterren</h1>
        <div class="hotel-images">
            <img src="images/edelweiss-hotel.jpg" alt="Hotel Edelweiss Zermatt" />
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Gezellig hotel met een warme sfeer, gelegen in het schilderachtige Zermatt.</p>
