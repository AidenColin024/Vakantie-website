...
<head>
    ...
    <title>Hotel Malta Vista - Malta</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Hotel Malta Vista – 4 sterren</h1>
        <div class="hotel-images">
            <img src="images/malta-hotel1.jpg" alt="Hotel Malta Vista" />
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Geniet van een prachtig uitzicht over de zee en de historische architectuur. Ideaal voor een ontspannen strandvakantie.</p>
