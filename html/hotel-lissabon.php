...
<head>
    ...
    <title>Hotel Lissabon – 5 sterren</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Hotel Lissabon – 5 sterren</h1>
        <div class="hotel-images">
            <img src="images/portugal-lissabon.jpg" alt="Hotel Lissabon" />
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Een luxe hotel in het hart van Lissabon met modern comfort en prachtige uitzichten over de stad.</p>
