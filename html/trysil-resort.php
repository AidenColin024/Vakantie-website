...
<head>
    ...
    <title>Trysil Resort – Noorwegen</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Trysil Resort – 4 sterren</h1>
        <div class="hotel-images">
            <img src="images/noorwegen-trysil.jpg" alt="Trysil Resort" />
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Een prachtig resort gelegen in het hart van Trysil, perfect voor wintersporters die comfort en avontuur zoeken.</p>
