...
<head>
    ...
    <title>Rhodos Luxe Hotel - Griekenland</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Rhodos Luxe Hotel – 5 sterren</h1>
        <div class="hotel-images">
            <img src="images/griekenland-hotel2.jpg" alt="Rhodos Luxe Hotel" />
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Een elegant hotel op Rhodos met prachtige suites, een luxe spa en eersteklas service voor een onvergetelijke vakantie.</p>
