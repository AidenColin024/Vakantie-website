...
$stmt->execute([':hotel' => "SalzburgerlandChalet"]);
...
<head>
    ...
    <title>Salzburgerland Chalet – Oostenrijk | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Salzburgerland Chalet – 5 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/voralberg%20lodge.jpg" alt="Salzburgerland Chalet" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Een luxe chalet in het Salzburgerland met moderne faciliteiten en een adembenemend uitzicht op de bergen.</p>
            ...
            <a href="../../boeking.php?hotel=SalzburgerlandChalet" class="pp-booking-btn">Boek nu</a>
