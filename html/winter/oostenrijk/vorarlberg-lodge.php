...
$stmt->execute([':hotel' => "VorarlbergLodge"]);
...
<head>
    ...
    <title>Vorarlberg Lodge – Oostenrijk | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Vorarlberg Lodge – 3 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/voralberg lodge.jpg" alt="Vorarlberg Lodge" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Gezellige lodge gelegen in het Vorarlberg gebied, geschikt voor gezinnen en wintersportliefhebbers.</p>
            ...
            <a href="../../boeking.php?hotel=VorarlbergLodge" class="pp-booking-btn">Boek nu</a>
