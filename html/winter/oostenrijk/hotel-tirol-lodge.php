...
<head>
    ...
    <title>Hotel Tirol Lodge – Oostenrijk | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Hotel Tirol Lodge – 4 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/hotel%20tirol%20lodge.jpg" alt="Hotel Tirol Lodge" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Comfortabel hotel in Tirol met moderne kamers, nabij skigebied en goede faciliteiten voor een ontspannen verblijf.</p>
            ...
            <ul>
                <li>Gratis WiFi</li>
                <li>Spa en zwembad</li>
                <li>Restaurant</li>
                <li>Skiliften dichtbij</li>
            </ul>

            <a href="../../boeking.php?hotel=TirolLodge" class="pp-booking-btn">Boek nu</a>
