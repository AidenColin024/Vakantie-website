...
$stmt->execute([':hotel' => "BernerHotelDeluxe"]);
...
<head>
    ...
    <title>Berner Hotel Deluxe – Zwitserland | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Berner Hotel Deluxe – 5 sterren</h1>
        <div class="hotel-images">
            <!-- Vervang pad/naam afbeelding naar de juiste! -->
            <img src="../../images/berner-hotel-deluxe.jpg" alt="Berner Hotel Deluxe" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Luxe hotel in het hart van Bern met uitzicht op de Alpen en uitgebreide wellness.</p>
            <h2>Prijs</h2>
            ...
            <ul>
                ...
                <li>Zwembad</li>
                <li>Gratis WiFi</li>
                <li>Gastronomisch restaurant</li>
            </ul>
            <a href="../../boeking.php?hotel=BernerHotelDeluxe" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
        ...
        <a href="zwitserland.php" class="pp-back-btn">← Terug naar Zwitserland vakanties</a>
    </section>
</main>
