...
$stmt->execute([':hotel' => "ZermattResort"]);
...
<head>
    ...
    <title>Zermatt Resort – Zwitserland | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Zermatt Resort – 5 sterren</h1>
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Luxe resort in Zermatt aan de voet van de Matterhorn, met ski-in/ski-out en wellness.</p>
            <h2>Prijs</h2>
            <p>Vanaf €250 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
            ...
            <a href="../../boeking.php?hotel=ZermattResort" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
