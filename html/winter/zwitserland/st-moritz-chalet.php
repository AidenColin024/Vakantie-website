...
$stmt->execute([':hotel' => "StMoritzChalet"]);
...
<head>
    ...
    <title>St. Moritz Chalet – Zwitserland | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>St. Moritz Chalet – 5 sterren</h1>
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Prachtige chalet in St. Moritz, met directe toegang tot de pistes en luxueuze faciliteiten.</p>
            <h2>Prijs</h2>
            ...
            <ul>
                ...
                <li>Gourmet keuken</li>
            </ul>
            <a href="../../boeking.php?hotel=StMoritzChalet" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
