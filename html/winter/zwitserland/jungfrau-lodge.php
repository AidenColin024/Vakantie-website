...
$stmt->execute([':hotel' => "JungfrauLodge"]);
...
<head>
    ...
    <title>Jungfrau Lodge – Zwitserland | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Jungfrau Lodge – 4 sterren</h1>
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Knusse lodge met uitzicht op de Jungfrau, ideaal voor natuurliefhebbers en gezinnen.</p>
            <h2>Prijs</h2>
            ...
            <a href="../../boeking.php?hotel=JungfrauLodge" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
