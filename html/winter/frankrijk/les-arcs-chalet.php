...
$stmt->execute([':hotel' => "LesArcsChalet"]);
...
<head>
    ...
    <title>Les Arcs Chalet – Frankrijk | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        ...
        <article class="hotel-info">
            ...
            <a href="../../boeking.php?hotel=LesArcsChalet" class="pp-booking-btn">Boek nu</a>
