...
$stmt->execute([':hotel' => "SerreChevalierLodge"]);
...
<head>
    ...
    <title>Serre Chevalier Lodge – Frankrijk | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Serre Chevalier Lodge – 3 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/serra%20chavalier%20lodge.webp" alt="Serre Chevalier Lodge" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Comfortabele lodge vlakbij de pistes van Serre Chevalier, ideaal voor gezinnen en skiërs.</p>
            ...
            <a href="../../boeking.php?hotel=SerreChevalierLodge" class="pp-booking-btn">Boek nu</a>
