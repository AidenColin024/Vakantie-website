...
$stmt->execute([':hotel' => "LaPlagneResort"]);
...
<head>
    ...
    <title>La Plagne Resort – Frankrijk | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>La Plagne Resort – 5 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/les%20plagne%20resort.jpg" alt="La Plagne Resort" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Luxueus resort in La Plagne met uitgebreide wellness en direct toegang tot de pistes.</p>
            ...
            <a href="../../boeking.php?hotel=LaPlagneResort" class="pp-booking-btn">Boek nu</a>
