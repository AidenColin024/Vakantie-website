...
$stmt->execute([':hotel' => "ChaletMontBlanc"]);
...
<head>
    ...
    <title>Chalet Mont Blanc – Frankrijk | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Chalet Mont Blanc – 5 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/chalet%20mont%20blanc.jpg" alt="Chalet Mont Blanc" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Exclusieve chalet met panoramisch uitzicht op de Mont Blanc, luxe wellness en privacy.</p>
            ...
            <a href="../../boeking.php?hotel=ChaletMontBlanc" class="pp-booking-btn">Boek nu</a>
