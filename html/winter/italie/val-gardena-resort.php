...
$stmt->execute([':hotel' => "ValGardenaResort"]);
...
<head>
    ...
    <title>Val Gardena Resort – Italië | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Val Gardena Resort – 5 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/val%20gardana%20resort.jpg" alt="Val Gardena Resort" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Luxueus resort in Val Gardena met eersteklas faciliteiten en een prachtig uitzicht op de bergen.</p>
            ...
            <ul>
                <li>Spa en sauna</li>
                <li>Restaurant met lokale keuken</li>
                <li>Gratis WiFi</li>
                <li>Skibushalte dichtbij</li>
            </ul>

            <a href="../../boeking.php?hotel=ValGardenaResort" class="pp-booking-btn">Boek nu</a>
        ...
        <a href="italie.php" class="pp-back-btn">← Terug naar Italië vakanties</a>
    </section>
</main>
