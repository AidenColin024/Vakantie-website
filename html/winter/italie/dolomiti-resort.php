...
$stmt->execute([':hotel' => "DolomitiResort"]);
...
<head>
    ...
    <title>Dolomiti Resort – Italië | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Dolomiti Resort – 4 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/dolomiti%20resort.jpg" alt="Dolomiti Resort" />
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Modern resort gelegen in het hart van de Dolomieten, met luxe faciliteiten en een prachtig uitzicht.</p>

            <h2>Prijs</h2>
            <p>Vanaf €100 per nacht</p>
            ...
            <a href="../../boeking.php?hotel=DolomitiResort" class="pp-booking-btn">Boek nu</a>
