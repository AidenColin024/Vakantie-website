...
$stmt->execute([':hotel' => "DolomietenChalet"]);
...
<head>
    ...
    <title>Dolomieten Chalet – Italië | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        ...
        <div class="hotel-images">
            <img src="../../images/dolomieten%20lodge.jpg" alt="Dolomieten Chalet" />
        </div>
        <article class="hotel-info">
            ...
            <a href="../../boeking.php?hotel=DolomietenChalet" class="pp-booking-btn">Boek nu</a>
