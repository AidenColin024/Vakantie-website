...
$stmt->execute([':hotel' => "CerviniaLodge"]);
...
<head>
    ...
    <title>Cervinia Lodge – Italië | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        ...
        <div class="hotel-images">
            <img src="../../images/cervinia%20lodge.jpg" alt="Cervinia Lodge" />
        </div>
        <article class="hotel-info">
            ...
            <a href="../../boeking.php?hotel=CerviniaLodge" class="pp-booking-btn">Boek nu</a>
