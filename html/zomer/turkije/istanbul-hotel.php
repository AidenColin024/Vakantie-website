...
$stmt->execute([':hotel' => "InstanbulHotel"]);
...
<head>
    ...
    <title>Instanbul Hotel – Turkije | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Instanbul Hotel – 5 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/istantbul.jpg" alt="Instanbul Hotel" />
            <!-- ![image5](image5) -->
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Modern hotel in het historische hart van Istanboel, met uitzicht op de Bosporus.</p>
            <h2>Prijs</h2>
            <p>Vanaf €200 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
                <li>Uitzicht op de Bosporus</li>
                <li>Gratis WiFi</li>
                <li>Turks bad</li>
                <li>Restaurant</li>
            </ul>
            <a href="../../boeking.php?hotel=InstanbulHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
