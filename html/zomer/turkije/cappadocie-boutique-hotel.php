...
$stmt->execute([':hotel' => "CappadocieBoutiqueHotel"]);
...
<head>
    ...
    <title>Cappadocië Boutique Hotel – Turkije | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Cappadocië Boutique Hotel – 4 sterren</h1>
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Sfeervol hotel in de grotten van Cappadocië, met unieke kamers en panoramisch uitzicht.</p>
            <h2>Prijs</h2>
            <p>Vanaf €160 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
                <li>Unieke grotkamers</li>
                <li>Panoramisch dakterras</li>
                <li>Gratis WiFi</li>
                <li>Ontbijtbuffet</li>
            </ul>
            <a href="../../boeking.php?hotel=CappadocieBoutiqueHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
