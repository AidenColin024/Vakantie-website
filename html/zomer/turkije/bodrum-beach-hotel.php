...
$stmt->execute([':hotel' => "BodrumBeachHotel"]);
...
<head>
    ...
    <title>Bodrum Beach Hotel – Turkije | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Bodrum Beach Hotel – 4 sterren</h1>
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Modern hotel aan het strand van Bodrum, met uitzicht op zee en een levendige beach club.</p>
            <h2>Prijs</h2>
            ...
            <a href="../../boeking.php?hotel=BodrumBeachHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
