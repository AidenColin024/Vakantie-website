...
$stmt->execute([':hotel' => "RiadMarrakesh"]);
...
<head>
    ...
    <title>Riad Marrakesh – Marokko | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Riad Marrakesh – 5 sterren</h1>
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Authentieke riad in het hart van Marrakesh, met traditionele patio en luxe kamers.</p>
            <h2>Prijs</h2>
            ...
            <a href="../../boeking.php?hotel=RiadMarrakesh" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
