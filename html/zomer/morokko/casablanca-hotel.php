...
$stmt->execute([':hotel' => "CasablancaHotel"]);
...
<head>
    ...
    <title>Casablanca Hotel – Marokko | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Casablanca Hotel – 4 sterren</h1>
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Stijlvol hotel in het centrum van Casablanca, met moderne kamers en dakterras.</p>
            <h2>Prijs</h2>
            ...
            <a href="../../boeking.php?hotel=CasablancaHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
