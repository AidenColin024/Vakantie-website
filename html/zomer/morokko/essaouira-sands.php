...
<head>
    ...
    <title>Essaouira Sands Resort - Marokko</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Essaouira Sands Resort – 4 sterren</h1>
        <div class="hotel-images">
            <img src="images/essaouira-sands.jpg" alt="Essaouira Sands Resort" />
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Geniet van de rust en charme van Essaouira in dit comfortabele resort met uitzicht op zee en traditionele architectuur.</p>
