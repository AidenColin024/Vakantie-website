...
$stmt->execute([':hotel' => "EssaouiraSands"]);
...
<head>
    ...
    <title>Essaouira Sands – Marokko | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Essaouira Sands – 4 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/assaouri%20sands.jpg" alt="Essaouira Sands" />
            <!-- ![image4](image4) -->
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Stijlvol hotel bij het strand van Essaouira, ideaal voor surfers en zonliefhebbers.</p>
            <h2>Prijs</h2>
            <p>Vanaf €110 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
                <li>Strand dichtbij</li>
                <li>Gratis WiFi</li>
                <li>Surfverhuur</li>
                <li>Restaurant</li>
            </ul>
            <a href="../../boeking.php?hotel=EssaouiraSands" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
        ...
        <a href="morokko.php" class="pp-back-btn">← Terug naar Marokko vakanties</a>
    </section>
</main>
