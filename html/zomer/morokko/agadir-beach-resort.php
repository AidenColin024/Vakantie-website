...
$stmt->execute([':hotel' => "AgadirBeachResort"]);
...
<head>
    ...
    <title>Agadir Beach Resort – Marokko | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Agadir Beach Resort – 5 sterren</h1>
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Luxe resort direct aan het strand van Agadir met zwembad, spa en diverse restaurants.</p>
            <h2>Prijs</h2>
            <p>Vanaf €190 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
            ...
            <a href="../../boeking.php?hotel=AgadirBeachResort" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
