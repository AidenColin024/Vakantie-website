...
$stmt->execute([':hotel' => "HotelOlympia"]);
...
<head>
    ...
    <title>Hotel Olympia – Griekenland | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Hotel Olympia – 3 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/olympia%20beach.jpg" alt="Hotel Olympia" />
            <!-- ![image3](image3) -->
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Gezellig hotel dichtbij de oude ruïnes van Olympia, perfect voor cultuur en ontspanning.</p>
            <h2>Prijs</h2>
            <p>Vanaf €90 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
                <li>Gratis WiFi</li>
                <li>Ontbijt inclusief</li>
                <li>Zwembad</li>
                <li>Restaurant</li>
            </ul>
            <a href="../../boeking.php?hotel=HotelOlympia" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
