...
$stmt->execute([':hotel' => "RhodesLuxeHotel"]);
...
<head>
    ...
    <title>Rhodes Luxe Hotel – Griekenland | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Rhodes Luxe Hotel – 5 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/rhodos.jpg" alt="Rhodes Luxe Hotel" />
            <!-- ![image3](image3) -->
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Luxe resort op Rhodos met privéstrand, diverse zwembaden en een uitstekende spa.</p>
            <h2>Prijs</h2>
            <p>Vanaf €210 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
                <li>Privéstrand</li>
            ...
            <a href="../../boeking.php?hotel=RhodesLuxeHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
