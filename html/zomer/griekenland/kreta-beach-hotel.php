...
$stmt->execute([':hotel' => "KretaBeachHotel"]);
...
<head>
    ...
    <title>Kreta Beach Hotel – Griekenland | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Kreta Beach Hotel – 5 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/kreta%20beach.jpg" alt="Kreta Beach Hotel" />
            <!-- ![image3](image3) -->
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Prachtig strandhotel op Kreta, met uitzicht op zee en luxe faciliteiten.</p>
            <h2>Prijs</h2>
            ...
            <a href="../../boeking.php?hotel=KretaBeachHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
