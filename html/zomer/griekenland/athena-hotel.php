...
<head>
    ...
    <title>Athene Boutique Hotel - Griekenland</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Athene Boutique Hotel – 3 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/griekenland-hotel3.jpg" alt="Athene Boutique Hotel" />
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Charmant boutique hotel in het centrum van Athene, perfect voor stadsontdekkers die comfort zoeken tegen een betaalbare prijs.</p>
