...
$stmt->execute([':hotel' => "AthenaHotel"]);
...
<head>
    ...
    <title>Athena Hotel – Griekenland | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Athena Hotel – 4 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/athene.jpg" alt="Athena Hotel" />
            <!-- ![image3](image3) -->
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Centraal gelegen hotel in Athene, ideaal voor een citytrip naar de Griekse hoofdstad.</p>
            <h2>Prijs</h2>
            ...
            <ul>
                ...
                <li>Ontbijtbuffet</li>
                <li>Restaurant</li>
                <li>Dakterras met uitzicht</li>
            </ul>
            <a href="../../boeking.php?hotel=AthenaHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
