...
<section class="vakantie zomer-hero">
    <img src="../images/ChatGPT%20Image%2021%20mei%202025,%2011_02_07.png" alt="Zomer vakanties" class="hero-img"/>
    <div class="hero-text">
    ...
    <div class="page-content">
        ...
        <section class="destination-blocks">
            ...
            <div class="destination-box" onclick="location.href='morokko.php'">
                <img src="../images/OIP%20(5).jpg" alt="Morokko"/>
                <h3>Morokko</h3>
            </div>
            <div class="destination-box" onclick="location.href='turkije.php'">
                <img src="../images/downloads%20(1).jpg" alt="Turkije"/>
                <h3>Turkije</h3>
            </div>
        </section>
