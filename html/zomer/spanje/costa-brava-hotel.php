...
$stmt->execute([':hotel' => "CostaBravaPalace"]);
...
<head>
    ...
    <title>Costa Brava Palace – Spanje | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        ...
        <article class="hotel-info">
            ...
            <a href="../../boeking.php?hotel=CostaBravaPalace" class="pp-booking-btn">Boek nu</a>
