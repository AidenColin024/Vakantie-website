...
$stmt->execute([':hotel' => "AndalusieHotel"]);
...
<head>
    ...
    <title>Andalusië Hotel – Spanje | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Andalusië Hotel – 4 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/andalusië%20resort.jpg" alt="Andalusië Hotel" />
            <!-- ![image2](image2) -->
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Charmant hotel in het hart van Andalusië, met authentieke sfeer en uitzicht op de bergen.</p>
            <h2>Prijs</h2>
            ...
            <a href="../../boeking.php?hotel=AndalusieHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
