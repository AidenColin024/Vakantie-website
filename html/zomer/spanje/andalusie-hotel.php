...
<head>
    ...
    <title>Andalusië Luxe Resort - Spanje</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Andalusië Luxe Resort – 5 sterren</h1>
        <div class="hotel-images">
            <img src="images/spanje-hotel2.jpg" alt="Andalusië Luxe Resort" />
        </div>
        <div class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Dit resort in Andalusië biedt luxe suites, prachtige tuinen en een ontspannen spa, ideaal voor een exclusieve vakantie onder de Spaanse zon.</p>
