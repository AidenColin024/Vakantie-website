...
$stmt->execute([':hotel' => "BarcelonaCityHotel"]);
...
<head>
    ...
    <title>Barcelona City Hotel – Spanje | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        ...
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Modern hotel in het centrum van Barcelona, ideaal voor een stedentrip met alle comfort.</p>
            <h2>Prijs</h2>
            <p>Vanaf €140 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
                <li>Gratis WiFi</li>
                <li>Ontbijtbuffet</li>
            ...
            <a href="../../boeking.php?hotel=BarcelonaCityHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
