...
$stmt->execute([':hotel' => "TenerifeHotel"]);
...
<head>
    ...
    <title>Tenerife Hotel – Spanje | Polar & Paradise</title>
...
<main class="pp-content">
    <section class="hotel-detail">
        <h1>Tenerife Hotel – 5 sterren</h1>
        <div class="hotel-images">
            <img src="../../images/tenerife%20apartement.jpg" alt="Tenerife Hotel" />
            <!-- ![image2](image2) -->
        </div>
        <article class="hotel-info">
            <h2>Beschrijving</h2>
            <p>Luxe hotel op Tenerife, direct aan het strand met tropische tuin en infinity pool.</p>
            <h2>Prijs</h2>
            <p>Vanaf €170 per nacht</p>
            <h2>Faciliteiten</h2>
            <ul>
                <li>Infinity pool</li>
            ...
            <a href="../../boeking.php?hotel=TenerifeHotel" class="pp-booking-btn">Boek nu</a>
            <h2>Reviews</h2>
