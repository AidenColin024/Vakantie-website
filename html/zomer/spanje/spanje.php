...
<section class="vakantie ski-hero">
    <img src="../../images/OIP4.jpg" alt="Skiën in Spanje" class="hero-img" />
    <div class="hero-text">
        <h1>Vind jouw perfecte ski vakantie</h1>
        <p>Van Oostenrijk tot Spanje, wij hebben de beste pistes voor jou geselecteerd.</p>

        <form method="GET" action="" id="hotelSearchForm">
            <label for="hotelSearch">Zoek hotel in Spanje:</label><br>
